...
public class ImageController {
    ...
    public void getImage(HttpServletResponse response, @PathVariable(value = "type") String type,
    ...
    public static  String saveImage(String path, MultipartFile file, String type) throws IOException
    {
        ...
        BufferedOutputStream stream = new BufferedOutputStream(new FileOutputStream(path + File.separator + uniqueName));
        stream.write(bytes);
        stream.flush();
        stream.close();
        return uniqueName;
